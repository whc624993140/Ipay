$(function() {
	$("body").append("<div class=\"modalWin simpleModalWin\"><div class=\"menuPop\"><div class=\"menuPopTitle\"><img src=\"static/v1/images/xiaoLogo.png\" style=\"position: absolute;top:10px;left: 20px;margin-top:-1px;\"/><span style=\"float: left;margin-left:70px; color: #000;\">"+wx_lang.page_key330+"</span><div class=\"menuPopClose\" style=\"cursor:pointer;color:#000;font-size: 24px;\">×</div></div>"+
					"<div style='height:360px;overflow-y: scroll;'><div class=\"uer_body clearfix\"><div class=\"userTag1 fl\"></input><div class=\"userTagTitle\"><label>"+wx_lang.page_key330+":</label><div class=\"tagCnt fl\" id=\"label_choose_1\"></div>"+
					"</div><div class=\"giftArea fl\" id=\"label_choose_2\"></div><div style=\"clear: both;\"></div><div class=\"giftArea fl\" id=\"label_choose_3\"></div></div></div></div><button class=\"btn_save\">"+wx_lang.page_key331+"</button>"+
			"</div></div>");
});
