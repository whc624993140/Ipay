$(function() {
	$("body").append("<div class=\"modalWin multiModalWin\"><div class=\"menuPop\"><div class=\"menuPopTitle\"><img src=\"static/v1/images/xiaoLogo.png\" style=\"position: absolute;top:10px;left: 20px;margin-top:-1px;\"/>"+
					"<span style=\"float: left;margin-left:70px; color: #000;\">"+wx_lang.page_key330+"</span><div class=\"menuPopClose\" style=\"cursor:pointer;color:#000;font-size: 24px\">×</div></div>"+
					"<div class='modal_scr'><div class=\"uer_body clearfix\"><div class=\"userTag1 fl\"></input><div class=\"userTagTitle\"><label>"+wx_lang.page_key330+":</label><div class=\"tagCnt fl\" id=\"label_mulit_choose_1\"></div>"+
					"</div><div class=\"giftArea fl\" id=\"label_mulit_choose_2\"></div><div style=\"clear: both;\"></div><div class=\"giftArea fl\" id=\"label_mulit_choose_3\"></div></div></div><lable class=\"lab\">"+wx_lang.page_key179+":</lable><div id=\"label_selected\"></div><button class=\"btn_save\">"+wx_lang.page_key337+"</button></div>"+
					"</div></div>");
});
