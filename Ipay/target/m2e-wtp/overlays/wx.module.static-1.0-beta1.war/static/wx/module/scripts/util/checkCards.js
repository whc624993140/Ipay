$(function() {
	$("body").append("<div name=\"card_choose_div\" class=\"layer fade\"><div class=\"modal_layer\"><div class=\"layer-content\"><div class=\"layer-header\"><div class=\"layer-title\">"+wx_lang.page_key272+"卡券</div>" +
			"<a class=\"close\" href=\"javascript:void(0)\">×</a></div><div class=\"layer-body layer_minH\"><div class=\"padTop\" ><table name=\"card_choose_table\" class=\"table\"><thead><tr>" +
					"<th>卡券ID</th><th>卡券"+wx_lang.page_key311+"</th><th>"+wx_lang.page_key383+"</th><th>库存</th><th>有效期</th><th>"+wx_lang.page_key284+"</th></tr></thead><tbody></tbody></table></div>" +
					"<div class=\"padTop\" name=\"card_choose_div_page\"></div></div><div class=\"layer-footer\"><a name=\"close\" class=\"btn btn-primary\" href=\"javascript:void(0)\">"+wx_lang.page_key405+"</a>" +
							"</div></div></div></div>");
});
...
//				alert(JSON.stringify(data));
			...
			var str = '<tr data-id="{98}" data-cardid="{99}"><td>{1}</td><td>{2}</td><td>{3}</td><td>{4}</td><td>{5}</td><td><a class="btn" href="javascript:void(0);" click="choose"><i class="icon-edit"></i>选择</a></td></tr>';
