    function dialogAlertShow(title,content,sure_fun,btn_name){
        ...
        $('#'+time+"d .title").html(title?title:wx_lang.page_key339);
        $('#'+time+"d .content").html(content);
        $('#'+time+"d .footer_item1").html(btn_name?btn_name:wx_lang.page_key337);
    ...
    function dialogConfirmShow(title,content,sure_fun,canl_fun,sure_btn_name,canl_btn_name){
        ...
        $(".title").html(title?title:wx_lang.page_key339);
        $(".content").html(content);
        $(".footer_item1").html(sure_btn_name?sure_btn_name:wx_lang.page_key337);
        $(".footer_item2").html(canl_btn_name?canl_btn_name:wx_lang.page_key338);
