$(function() {
	$("body").append("<div class=\"modalWin simpleModalWin\"><div class=\"menuPop\"><div class=\"menuPopTitle\"><img src=\"static/moudles/util/images/xiaoLogo.png\" style=\"position: absolute;top:10px;left: 20px;margin-top:-1px;\"/><span style=\"float: left;margin-left:70px; color: #000;\">标签筛选</span><div class=\"menuPopClose\" style=\"cursor:pointer;color:#000;font-size: 24px;\">×</div></div>"+
