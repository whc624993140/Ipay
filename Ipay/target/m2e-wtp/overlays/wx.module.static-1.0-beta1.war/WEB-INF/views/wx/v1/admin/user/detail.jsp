...
<body>
		...
		<div class="pageTitle fl">个人<fmt:message key="page.key487"/>中心</div>
		<div class="personalUser">
			<div class="personalUserPhoto fl">
				<img src="images/my.png" alt="" />
			</div>
			<div class="personalUserInfo fl" >
				<p><fmt:message key="page.key305"/>：迪利努尔泰山</p>
				<p>性别：<fmt:message key="page.key220"/></p>
				<p>省份：新疆维吾尔族自治区</p>
			</div>
			...
			<div class="perMessTime">
				<ul>
					<li>发消息<fmt:message key="page.key40"/>：<a>3</a></li>
					<li>平均阅读市时长：<a>3</a></li>
					<li>领取卡券：<a>3</a></li>
					<li>使用卡券<fmt:message key="page.key458"/>：<a>3</a></li>
				</ul>
			</div>
		</div>
		<div class="perAttentionWay">
			<div class="perAttentionWay_t"><fmt:message key="page.key291"/>渠道</div>
			<div class="perAttentionWay_cnt">
				<span>2015-4-18来源于线下推广活动vago活动现场青春傲然扫<fmt:message key="page.key308"/><fmt:message key="page.key291"/></span>
			</div>
		</div>
		<div class="perAttentionWay">
			<div class="perAttentionWay_t">所属<fmt:message key="page.key330"/></div>
			<div class="perAttentionWay_cnt">
				<span><a>梵高</a><a>吃货</a></span>
			</div>
		</div>
		<div class="perAttentionWay">
			<div class="perAttentionWay_t"><fmt:message key="page.key487"/>行为分析</div>
			<div class="perAttentionWay_cnt">
			...
			<div class="personalMaskCnt">
				...
				<div class="perMessage">
					...
					<div class="perBtnArea">
						<button>模板消息</button>
						<button><fmt:message key="page.key408"/>素材</button>
						<button><fmt:message key="page.key268"/></button>
					</div>
				</div>
				<div class="perRecord">
					<div class="perRecord_t"><fmt:message key="page.key262"/><span>(<fmt:message key="page.key403"/>999+<fmt:message key="page.key464"/>)</span>
						<div class="imgOnly">
							<input type="checkbox" />
							仅显示<fmt:message key="page.key184"/>消息
						</div>
					</div>
					<ul>
						<li>
							...
							<div class="messCnt_per fl">
								<p>宜家俱乐部测试号</p>
								<a>验证<fmt:message key="page.key387"/>！您的公众号已经<fmt:message key="page.key387"/>迁移<fmt:message key="page.key214"/>微信后斯特！</a>
...
<script src="static/wx/module/scripts/personalCenter.js"></script>
</body>
</html>
