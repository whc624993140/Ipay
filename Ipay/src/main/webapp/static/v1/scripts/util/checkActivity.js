$(function() {
	$("body").append("<div class=\"modalWin activityModalWin\"><div class=\"menuPop\"><div class=\"menuPopTitle\"><img src=\"static/v2/img/xiaoLogo.png\" style=\"position: absolute;top:10px;left: 20px;margin-top:-1px;\"/><span style=\"float: left;margin-left:70px; color: #000;\">活动筛选</span><div class=\"menuPopClose\" style=\"cursor:pointer;color:#000;font-size: 24px;\">×</div></div>"+
					"<div style='height:360px;overflow-y: scroll;'><div class=\"uer_body clearfix\"><div class=\"userTag1 fl\"></input><div class=\"userTagTitle\"><label>活动名称：</label><div class=\"tagCnt fl\" id=\"activity_choose_1\"></div>"+
					"</div><div class=\"giftArea fl\" id=\"activity_choose_2\"></div><div style=\"clear: both;\"></div></div></div></div><button class=\"btn_save\">保存</button>"+
			"</div></div>");
});
...
var activity_choose={
		...
		hide:function(){
			...
			var initUrl = "maserati/giftactivity/admin/findAll";
