...
<body>
		...
		<div class="label-body fl">
			<div class="label-model model-fl modelone">
				...
				<div class="label-title"><fmt:message key="page.key123"/></div>
			...
			<div class="label-model model-fl modeltwo">
				...
				<div class="label-title"><a data-parent="0">二级标签_上级标签</a>><span></span></div>
			...
			<div class="label-model model-fl modelthree">
				...
				<div class="label-title"><a data-parent="1">三级标签_上级标签</a>><span></span></div>
    ...
    <span style="color:#000">增加、编辑或者删除菜单</span>
				...
				<div class="labelCntDisp">
					...
					名称:<input type="text"  name="name" id="name"></input>
					<br/>
					key：<input type="text"  name="key"  id="key"></input>
				</div>
				<button class='allBtn labelBtn'>确定</button>
			</div>
		</div>
		<%@ include file="/WEB-INF/views/v1/include/Javascript.inc" %>
		<script src="static/v1/scripts/label.js"></script>
</body>
</html>